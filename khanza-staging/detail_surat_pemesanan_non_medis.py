...
try:
    ...
    api_url = f"{API_URL}/detail_surat_pemesanan_non_medis"
    ...
    insert_query = """
        INSERT INTO detail_surat_pemesanan_non_medis (
            ...
            %(subtotal)s, %(dis)s, %(besardis)s, %(total)s
        )
    ...
    print(f"{target_cursor.rowcount} baris berhasil dimigrasikan ke detail_surat_pemesanan_non_medis dari API.")
