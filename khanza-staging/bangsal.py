...
try:
    ...
    bangsal_url = f"{API_URL}/bangsal"
    response = requests.get(bangsal_url, headers=headers)
    ...
    print(f"{target_cursor.rowcount} baris berhasil dimigrasikan ke bangsal dari API.")
