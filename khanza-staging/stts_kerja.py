...
try:
    ...
    stts_url = f"{API_URL}/stts_kerja"
    response = requests.get(stts_url, headers=headers)
    ...
    print(f"{target_cursor.rowcount} baris berhasil dimigrasikan ke stts_kerja dari API.")
