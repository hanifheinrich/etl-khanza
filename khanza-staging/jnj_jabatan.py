...
try:
    ...
    insert_query = """
        INSERT INTO jnj_jabatan (
            kode, nama, tnj, indek
        ) VALUES (
            %(kode)s, %(nama)s, %(tnj)s, %(indek)s
        )
    ...
    print(f"{target_cursor.rowcount} baris berhasil dimigrasikan ke jnj_jabatan dari API.")
